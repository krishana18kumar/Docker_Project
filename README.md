...
![yml file](docker%20images/8_yml%20file1.png)
![yml file continued](docker%20images/9_yml%20file2.png)
...
* Use `#docker-compose up` and `#docker-compose down` to start and stop services respectively.
 ...
 ![docker compose up output](docker%20images/10_output.png)
 ![docker compose down](docker%20images/11_docker%20compose%20down.png)
 ![docker compose down output](docker%20images/11_output.png)
